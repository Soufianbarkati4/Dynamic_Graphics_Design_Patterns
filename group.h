...
public: 
    ...
    void add(Figure *fig) { fig->set_group(this); _children.insert(fig); }
	...
	// for DECORATOR (replace a figure by another in a group)
	//
	...
	virtual void accept(Visitor &v) {
		v.visit(*this);
		for (auto chld: _children) chld->accept(v);
	}
};
